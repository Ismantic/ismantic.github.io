...
尝试训练了下165M和315M的BERT模型，用了中文字符，英文BPE的Tokenizer，模型结构上能简则简，训练时间上315M是165M的二倍以上，以CSC任务来看，F1 0.8308 -> 0.8346，多任务训练CWS/POS/NER来看，CWS F1 0.9836 -> 0.9840，POS 0.9753 -> 0.9800，NER 0.9632 -> 0.9660。四个任务确实也都有提高，但其实幅度很小了，这就是BERT的问题，因为只能做这样的任务，效果到天花板了，就不能Scale了。
